...
instance : 𝗘𝗤 ⪯ 𝗭𝗖 := Entailment.WeakerThan.trans (inferInstance : 𝗘𝗤 ⪯ 𝗭) inferInstance
...
instance : 𝗘𝗤 ⪯ 𝗭𝗙𝗖 := Entailment.WeakerThan.trans (inferInstance : 𝗘𝗤 ⪯ 𝗭𝗙) inferInstance
