...
lemma empty_exists : ∃ e : V, IsEmpty e := by
  simpa [models_iff, Axiom.empty, IsEmpty] using ModelsTheory.models V Zermelo.axiom_of_empty_set
...
lemma isInductive_exists : ∃ I : V, IsInductive I := by
  simpa [models_iff, Axiom.infinity, IsInductive] using ModelsTheory.models V Zermelo.axiom_of_infinity
