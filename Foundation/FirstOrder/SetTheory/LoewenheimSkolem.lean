...
def set_nonempty : (Hull s).Nonempty := Structure.SkolemHull.set_nonempty _ _
...
def set_countable [hs : Countable s] : (Hull s).Countable := Structure.SkolemHull.set_countable hs
